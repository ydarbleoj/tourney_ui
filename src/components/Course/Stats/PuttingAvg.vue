              ...
              <v-flex xs6>
                <v-layout row wrap>
                  <v-flex xs12 class="mb-2">
                    <h2 class="text-xs-center mt-1 mb-2 font-weight-regular ">Putting Avg</h2>
                  </v-flex>
                  <v-flex xs12>
...
export default {
  ...
  methods: {
    ...
    loadFields () {
      ...
      let net     = this.isNet
      this.yearsField = round['putts_avg']
      this.courseOverall = course['putts_avg']
      this.personalBest = 36
    },
  },
