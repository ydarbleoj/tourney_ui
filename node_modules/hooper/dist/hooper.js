...
(function (global, factory) {
    ...
    methods: {
      ...
      initAutoPlay() {
        this.timer = new Timer(() => {
          if (this.isSliding || this.isDraging || this.isHover || this.isFocus) {
            return;
          }
      ...
      updateSlidesStatus(index) {
        ...
        this.allSlides.forEach((slide, index) => {
          if (index >= currentSlideIndex && index < currentSlideIndex + this.$settings.itemsToShow) {
  ...
  var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',{staticClass:"hooper",class:{
    ...
    },attrs:{"tabindex":"0"},on:{"mouseover":function($event){_vm.isHover = true;},"mouseleave":function($event){_vm.isHover = false;},"focusin":function($event){_vm.isFocus = true;},"focusout":function($event){_vm.isFocus = false;}}},[_c('ul',{ref:"track",staticClass:"hooper-track",class:{ 'is-dragging': _vm.isDraging },style:(_vm.trackTransform),on:{"transitionend":_vm.onTransitionend}},[_vm._t("default")],2),_vm._v(" "),_vm._t("hooper-addons"),_vm._v(" "),_c('div',{staticClass:"hooper-liveregion hooper-hidden",attrs:{"aria-live":"polite","aria-atomic":"true"}},[_vm._v("\n    "+_vm._s(("Item " + (_vm.currentSlide + 1) + " of " + _vm.slidesCount))+"\n  ")])],2)};
  ...
  var __vue_render__$4 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"hooper-navigation",class:{
    ...
    }},[_c('button',{staticClass:"hooper-prev",class:{ 'is-disabled': _vm.isPrevDisabled },on:{"click":_vm.slidePrev}},[_vm._t("hooper-prev",[_c('icons',{attrs:{"name":"arrowLeft"}})])],2),_vm._v(" "),_c('button',{staticClass:"hooper-next",class:{ 'is-disabled': _vm.isNextDisabled  },on:{"click":_vm.slideNext}},[_vm._t("hooper-next",[_c('icons',{attrs:{"name":"arrowRight"}})])],2)])};
