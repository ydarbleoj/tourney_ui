...
// node_modules/vue-scroll-picker/lib/vue-scroll-picker.mjs
function v(t, e = 83) {
  let i = null;
  return function() {
...
var I = defineComponent({
  ...
  methods: {
    ...
    onStart(t) {
      ...
      const { clientY: e } = c(t);
      this.start = [this.scroll, e], u(t) || (this.isMouseDown = true), this.isDragging = false;
    },
    onMove(t) {
      if (t.cancelable && t.preventDefault(), !this.start)
        return;
      const { clientY: e } = c(t), i = e - this.start[1];
      Math.abs(i) > 1.5 && (this.isDragging = true), this.scroll = this.start[0] + i * (u(t) ? this.touchSensitivity : this.dragSensitivity);
    },
    onEnd(t) {
      t.cancelable && t.preventDefault(), this.isDragging ? this.correction(this.findIndexFromScroll(this.scroll)) : this.isMouseDown && this.onClick(t), this.start = null, this.isDragging = false, this.isMouseDown = false;
    },
    ...
    onCancel(t) {
      t.cancelable && t.preventDefault(), this.correction(this.internalIndex), this.start = null, this.isMouseDown = false, this.isDragging = false;
    },
    onClick(t) {
    ...
    correction(t) {
      ...
      this.scroll = this.findScrollByIndex(e), this.transitioning = true, this.transitionTimer && (clearTimeout(this.transitionTimer), this.transitionTimer = null), this.transitionTimer = setTimeout(() => {
        this.transitioning = false, this.transitionTimer = null, this.internalIndex = e, this.internalValue !== i && this.$emit("update:modelValue", this.internalValue = i);
      }, 100);
    }
  },
  render() {
    let t = [];
    return this.hasPlaceholder ? t.push(h("div", {
      class: [
      ...
      this.placeholder
    ]))) : this.internalOptions.length === 0 && t.push(h("div", {
      class: [
        "vue-scroll-picker-item",
      ...
      this.empty
    ]))), t = t.concat(this.internalOptions.map((e, i) => h("div", {
      class: [
        "vue-scroll-picker-item",
        {
    ...
    }, renderSlot(this.$slots, "default", { option: e }, () => [
      e.name
    ])))), h("div", {
      class: [
        "vue-scroll-picker"
...
//# sourceMappingURL=vue-scroll-picker.js.map
